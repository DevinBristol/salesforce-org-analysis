...
class SystemInitializer {
    ...
    async run() {
        ...
        console.log(chalk.cyan.bold('║     Autonomous Salesforce System Initialization     ║'));
        console.log(chalk.cyan.bold('╚══════════════════════════════════════════════════════╝\n'));
        ...
        try {
            ...
            metadataSpinner.succeed(`Metadata fetched: ${Object.keys(metadata).length} types`);
            ...
            console.log(chalk.gray('  • Run the demo: npm run demo:apex-improvement\n'));
